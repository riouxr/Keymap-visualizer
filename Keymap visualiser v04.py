bl_info = {
    ...
    "description": "Visualizes assigned hotkeys with enhanced keyboard layout, details at bottom",
    "category": "Interface",
}
...
class KeymapCheckerPrefs(bpy.types.PropertyGroup):
    ...
    cmd: bpy.props.BoolProperty(name="Cmd", default=False) if platform.system() == 'Darwin' else bpy.props.BoolProperty(name="Cmd", default=False, description="Mac Command key")
...
class VIEW3D_PT_KeymapChecker(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        if prefs.selected_key:
            ...
            if prefs.alt:
                label.append("Alt")
            if prefs.cmd and platform.system() == 'Darwin':
                label.append("Cmd")
